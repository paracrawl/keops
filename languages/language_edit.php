    ...
    <div class="container">
      ...
      <form class="form-horizontal" method="post" action="../languages/update_language.php" role="form" data-toggle="validator">
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <input id="langcode" name="langcode" class="form-control" aria-describedby="helpLangCode" placeholder="Language code" maxlength="5" required="" autofocus="" value="<?php echo $lang->langcode; ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <input id="langname" name="langname" class="form-control" aria-describedby="helpLangName" placeholder="Language name" maxlength="200" required="" value="<?php echo $lang->langname; ?>">
