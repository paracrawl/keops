      ...
      <form class="form-horizontal" method="post" action="../languages/add_language.php" role="form" data-toggle="validator">
        <div class="form-group">
          ...
          <div class="col-sm-7">
            ...
            <div id="helpLangCode" class="help-block">Two-letter <a target="_blank" href="http://www.loc.gov/standards/iso639-2/php/code_list.php">ISO 639-1</a> language code</div>
          </div>
        </div>
        <div class="form-group">
            <label for="langname" class="col-sm-1 control-label">Language name</label>
            <div class="col-sm-7">
                <input id="langname" name="langname" class="form-control" aria-describedby="helpLangName" placeholder="Language name" maxlength="200" tabindex="2">
<!--              <div id="helpInvitation" class="help-block with-errors"></div>-->
            </div>
        </div>
        <div class="form-group">
