...
<body>
  <div class="container">
    ...
    <ul class="nav nav-tabs" role="tablist" id="corpus-upload-tabs">
      ...
      <li role="presentation"><a href="#corpora_validation_mac" data-toggle="tab">Validation (MaCoCu) <span class="label label-default ml-1">BETA</span></a></li>
      <li role="presentation"><a href="#corpora_mono" data-toggle="tab">Monolingual evaluation <span class="label label-default ml-1">BETA</span></a></li>
    ...
    <div class="tab-content pt-4">
      ...
      <div class="tab-pane" id="corpora_ranking">
        ...
        <div class="tab-pane" id="corpora_paraphrases">
            ...
            <div class="row mt-4">
                ...
                <div class="col-xs-12 col-md-12 mt-4">
                    <table id="corpora-table-par" class="corpora-table table table-striped table-bordered display responsive nowrap" cellspacing="0" style="width:100%;">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
        ...
        <div class="tab-pane active" id="corpora_validation_mac">
        <div class="row">
          <div class="col-md-12 col-xs-12">
          ...
          <div class="col-md-12 col-xs-12">
            <div class="h3 my-4">Uploaded corpora</div>
            <table id="corpora-table-valmac" class="corpora-table table table-striped table-bordered display responsive nowrap" cellspacing="0" style="width:100%;">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Name</th>
     ...
     <div class="tab-pane" id="corpora_mono">
        <div class="row">
          <div class="col-md-12 col-xs-12">
          ...
          <div class="col-md-12 col-xs-12">
            <div class="h3 my-4">Uploaded corpora</div>
            <table id="corpora-table-mono" class="corpora-table table table-striped table-bordered display responsive nowrap" cellspacing="0" style="width:100%;">
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Name</th>
